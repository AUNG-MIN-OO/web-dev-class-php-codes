                                ...
                                <div class="row">
                                    <div class="col-12 col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="file" name="photo" class="form-control p-1 " id="photo"  required>
                                        </div>
                                        <div class="form-group">
                                            <label for="name">
                                                Item Name
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="cate" id="cate" class="form-control custom-select">
                                    ...
                                    <div class="col-12 col-md-6">
                                        <div class="row">
                                            ...
                                            <div class="col-6">
                                                ...
                                                <select name="type" id="unit_type" class="form-control custom-select">
                                                    <option value="0">Drinks</option>
                                                    <option value="1">Snacks</option>
                                                </select>
                                            </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea type="text" name="des" id="des" class="form-control" rows="9">Hello from My Shop</textarea>
                                        </div>
                                    </div>
                                </div>
                                <hr>
